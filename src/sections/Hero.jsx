...
import Developer2Img from "../assets/Images/DeveloperImg.jpeg";
import Developer1Img from "../assets/Images/developer1.png";
import DeveloperImg from "../assets/Images/developer.png";

function Hero() {
  return (
    <section id="home" className="pt-32 pb-20 min-h-screen flex flex-col md:flex-row items-center justify-between px-8 gap-10 relative transition duration-700 ease-out" >
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
        ...
        <div>
          ...
          <p className="mt-6 text-lg text-gray-600">
            I build responsive web applications using React, Tailwind and modern
            JavaScript.
          </p>
